      ...
      <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
        ...
        <div class="row">
          <div id="scrolling_to_bottom" class="col-md-12 right-header-contentChat">
            ...
            $update_msg = mysqli_query($con, "UPDATE user_chats SET msg_status='read' WHERE sender_username='$username' AND receiver_username='$user_name'");
        ...
        <div class="row">
          <div class="col-md-12 right-chat-textbox">
            ...
            <button class="btn" name="sm"><i class="fa fa-telegram" aria-hidden="true"></i></button>
